...
namespace Resanehlab.Plugin.Products.ProductComments.Domain
{
    public partial class ProductComment : BaseEntity
    {
        ...
        {
            get { return _productCommentHelpfulnessEntries ?? (_productCommentHelpfulnessEntries = new List<ProductCommentHelpfulness>()); }
            protected set { _productCommentHelpfulnessEntries = value; }
        }
    }
}
